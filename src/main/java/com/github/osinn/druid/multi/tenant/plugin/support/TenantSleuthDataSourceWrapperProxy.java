...
public class TenantSleuthDataSourceWrapperProxy {

    public TenantSleuthDataSourceWrapperProxy(DataSource dataSource, DefaultSqlParser defaultSqlParser) {
        if (dataSource instanceof DataSourceWrapper) {
            ...
            if (originalDataSource instanceof DynamicRoutingDataSource) {
                ...
                this.addProxyFilter(dynamicRoutingDataSource, defaultSqlParser);
            }
        }
    }


    private void addProxyFilter(DynamicRoutingDataSource dynamicRoutingDataSource, DefaultSqlParser defaultSqlParser) {
